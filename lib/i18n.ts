...
const dict = {
  ...
  soloEntry:      { en: "Entering on your own", te: "ఒక్కరుగా నమోదు" },
  groupNote:      { en: "A group counts as one ticket in the draw, however many villas are in it.", te: "గ్రూప్‌లో ఎన్ని విల్లాలు ఉన్నా, డ్రాలో ఒకే టికెట్‌గా లెక్కిస్తారు." },
  soloOrGroup:    { en: "You can enter on your own — that is a complete entry. Or share it with other villas. Either way it is one ticket in the draw.", te: "మీరు ఒక్కరుగానే చేరవచ్చు — అది పూర్తి నమోదు. లేదా ఇతర విల్లాలతో కలిసి చేరవచ్చు. రెండూ డ్రాలో ఒకే టికెట్." },
  soloEntered:    { en: "You are entered on your own. Nothing more is needed.", te: "మీరు ఒక్కరుగా నమోదయ్యారు. ఇంకేమీ చేయనవసరం లేదు." },
